...
/** Computes the ZIP CRC32 checksum for one entry. */
function crc32(data) {
  let crc = 0xffffffff;
...
/** Encodes one unsigned 16-bit integer in little-endian order. */
function u16(value) {
...
/** Encodes one unsigned 32-bit integer in little-endian order. */
function u32(value) {
...
/** Reads and validates one package source file. */
...
/** Builds one local file header for a ZIP entry. */
...
/** Builds one central directory header for a ZIP entry. */
...
/** Packs the demo package into a ToolPkg archive. */
