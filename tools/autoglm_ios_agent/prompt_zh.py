"""System prompt for the AutoGLM-Phone model (Chinese).

Verbatim copy of Open-AutoGLM's phone_agent/config/prompts_zh.py SYSTEM_PROMPT.
This defines the action grammar the model outputs. Do NOT rewrite it — the
18 task rules + action definitions are what make the agent actually work.
Source: https://github.com/zai-org/Open-AutoGLM (MIT).
"""
