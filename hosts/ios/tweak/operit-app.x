...
%ctor {
    g_frontpath = @"/var/mobile/.operit/front.pid";
    ...
    int pid = getpid();
    g_oc_logpath = [NSString stringWithFormat:@"%@/logs/app-%d.log", @"/var/mobile/.operit", pid];
    ...
    NSString *path = [NSString stringWithFormat:@"%@/app.%d.sock", @"/var/mobile/.operit", pid];
